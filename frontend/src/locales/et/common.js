...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "OnesLLM töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      title: "Tere tulemast OnesLLM-i",
      description:
        "Aita meil OnesLLM sinu vajadustele vastavaks kujundada. Valikuline.",
      email: "Mis on su e-post?",
      useCase: "Milleks kasutad OnesLLM-i?",
      useCaseWork: "Töö jaoks",
      useCasePersonal: "Isiklikuks kasutuseks",
      useCaseOther: "Muu",
      comment: "Kust kuulsid OnesLLM-ist?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Loo esimene tööruum ja alusta OnesLLM-iga.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Tere tulemast OnesLLM-i! See on Mintplex Labsi avatud lähtekoodiga AI-tööriist, mis muudab kõik failid koolitatud juturobotiks, kellega saad vestelda. OnesLLM on BYOK-tarkvara, seega puudub igasugune tellimus- või litsentsitasu, välja arvatud kasutatavate teenuste kulud.",
    part2:
      "OnesLLM on lihtsaim viis kombineerida võimsad AI-teenused nagu OpenAI, GPT-4, LangChain, PineconeDB, ChromaDB jpt ilma vaevata, tõstes sinu produktiivsust kordades.",
    part3:
      "OnesLLM võib töötada täielikult lokaalselt sinu masinas minimaalse ressursikasutusega – GPU-d pole vaja. Samuti on saadaval pilve- ja kohapealsed paigaldised.\nAI-ökosüsteem muutub iga päevaga võimekamaks ja OnesLLM teeb selle kasutamise lihtsaks.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Oled teel OnesLLM-i eksperdiks saama!",
      dismiss: "sulge",
      tasks: {
        create_workspace: {
          title: "Loo tööruum",
  ...
  customization: {
    interface: {
      ...
      description: "Sea OnesLLM-i UI eelistused.",
    },
    branding: {
      title: "Bränding ja valgesildistamine",
      description: "Valgesildista oma OnesLLM kohandatud brändinguga.",
    },
    chat: {
      title: "Vestlus",
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles OnesLLM UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda OnesLLM instantsi.",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul OnesLLM ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et OnesLLM saaks sinu failid ja päringud töödelda.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas OnesLLM töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Konfiguratsioon kolmandate osapoolte ja OnesLLM-i andmekäitluse kohta.",
    llm: "LLM-i valik",
