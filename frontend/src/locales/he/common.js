...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "OnesLLM יכול לעבוד עם ספקי מודלי שפה (LLM) רבים. זה יהיה השירות שיטפל בצ'אט.",
    },
    userSetup: {
      title: "הגדרת משתמש",
    ...
    survey: {
      title: "ברוכים הבאים ל-OnesLLM",
      description:
        "עזרו לנו לבנות את OnesLLM כך שיתאים לצרכים שלכם. אופציונלי.",
      email: "מה האימייל שלך?",
      useCase: "לאיזו מטרה תשתמש ב-OnesLLM?",
      useCaseWork: "לעבודה",
      useCasePersonal: "לשימוש אישי",
      useCaseOther: "אחר",
      comment: "איך שמעת על OnesLLM?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "צור את סביבת העבודה הראשונה שלך והתחל לעבוד עם OnesLLM.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "ברוכים הבאים ל-OnesLLM, כלי קוד פתוח מבית Mintplex Labs שהופך כל דבר לצ'אטבוט מאומן שאפשר לשאול ולשוחח איתו. OnesLLM היא תוכנת BYOK (הבא-מפתחות-משלך) כך שאין מנוי, עמלה או חיובים עבור תוכנה זו מלבד השירותים שברצונך להשתמש בהם.",
    part2:
      "OnesLLM היא הדרך הקלה ביותר לשלב מוצרי AI חזקים כמו OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB ושירותים אחרים בחבילה מסודרת אחת ללא מאמץ, כדי להגביר את הפרודוקטיביות שלך פי 100.",
    part3:
      "OnesLLM יכול לרוץ באופן מקומי לחלוטין על המחשב שלך עם תקורה נמוכה, עד כדי כך שלא תשים לב שהוא שם! אין צורך ב-GPU. התקנה בענן ובשרתים מקומיים זמינה גם כן.\nמערכת כלי ה-AI מתחזקת מדי יום. OnesLLM מקל על השימוש בה.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "אתה בדרך להפוך למומחה OnesLLM!",
      dismiss: "סגור",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "הגדר את העדפות ממשק המשתמש שלך עבור OnesLLM.",
    },
    branding: {
      title: "מיתוג והתאמה אישית (Whitelabeling)",
      description: "התאם אישית את מופע ה-OnesLLM שלך עם מיתוג מותאם אישית.",
    },
    chat: {
      title: "צ'אט",
      description: "הגדר את העדפות הצ'אט שלך עבור OnesLLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "שפת תצוגה",
        description:
          "בחר את השפה המועדפת להצגת ממשק המשתמש של OnesLLM - כאשר תרגומים זמינים.",
      },
      logo: {
        title: "לוגו מותג",
      ...
      "welcome-messages": {
        ...
        user: "משתמש",
        message: "הודעה",
        assistant: "עוזר הצ'אט של OnesLLM",
  ...
  api: {
    title: "מפתחות API",
    description:
      "מפתחות API מאפשרים למחזיק בהם לגשת ולנהל באופן תכנותי את מופע OnesLLM זה.",
  ...
  llm: {
    title: "העדפות מודל שפה (LLM)",
    description:
      "אלה האישורים וההגדרות עבור ספק הצ'אט וההטמעה המועדף עליך. חשוב שמפתחות אלה יהיו עדכניים ונכונים, אחרת OnesLLM לא יפעל כראוי.",
    provider: "ספק LLM",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "ספק תמלול",
    "warn-start":
      "שימוש במודל ה-whisper המקומי על מכונות עם זיכרון RAM או מעבד מוגבלים עלול לגרום להאטה של OnesLLM בעת עיבוד קובצי מדיה.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "הטמעה היא תהליך של הפיכת טקסט לווקטורים. אישורים אלה נדרשים כדי להפוך את הקבצים וההנחיות שלך לפורמט ש-OnesLLM יכול להשתמש בו לעיבוד.",
    provider: {
      title: "ספק הטמעה",
    },
  },
  ...
  vector: {
    ...
    description:
      "אלה האישורים וההגדרות לאופן פעולת מופע ה-OnesLLM שלך. חשוב שמפתחות אלה יהיו עדכניים ונכונים.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "זוהי התצורה שלך לאופן שבו ספקים צד שלישי מחוברים ו-OnesLLM מטפלים בנתונים שלך.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "קבצים אלה יועלו למעבד המסמכים הפועל במופע זה של OnesLLM. קבצים אלה אינם נשלחים או משותפים עם צד שלישי.",
    },
    pinning: {
      what_pinning: "מהי הצמדת מסמכים?",
      pin_explained_block1:
        "כאשר אתה <b>מצמיד</b> מסמך ב-OnesLLM, אנו נזריק את כל תוכן המסמך לחלון ההנחיה שלך כדי שמודל השפה שלך יבין אותו במלואו.",
      pin_explained_block2:
        "זה עובד בצורה הטובה ביותר עם <b>מודלים בעלי הקשר רחב</b> או קבצים קטנים שהם קריטיים לבסיס הידע שלו.",
      pin_explained_block3:
        "אם אינך מקבל את התשובות הרצויות מ-OnesLLM כברירת מחדל, הצמדה היא דרך מצוינת לקבל תשובות איכותיות יותר בלחיצה אחת.",
      accept: "אוקיי, הבנתי",
    },
    watching: {
      what_watching: "מה עושה מעקב אחר מסמך?",
      watch_explained_block1:
        "כאשר אתה <b>עוקב</b> אחר מסמך ב-OnesLLM, אנו נסנכרן <i>אוטומטית</i> את תוכן המסמך שלך ממקורו המקורי במרווחי זמן קבועים. זה יעדכן אוטומטית את התוכן בכל סביבת עבודה שבה קובץ זה מנוהל.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "נדרש אימות",
          description:
            "עליך להתאמת עם מרכז הקהילה של OnesLLM לפני פרסום פריטים.",
  ...
  security: {
    ...
    password: {
      title: "הגנת סיסמה",
      description:
        "הגן על מופע ה-OnesLLM שלך באמצעות סיסמה. אם תשכח אותה, אין שיטת שחזור, אז ודא שאתה שומר סיסמה זו.",
