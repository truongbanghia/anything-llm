...
/**
 * An interface to the OnesLLM Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the OnesLLM instance.
  ...
  /**
   * Apply an item to the OnesLLM instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the OnesLLM instance by downloading the zip file and importing it.
