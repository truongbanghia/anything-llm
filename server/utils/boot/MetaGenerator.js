  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "OnesLLM | Your personal LLM trained on anything",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://onesllm.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://onesllm.com" },
      },
      {
        tag: "meta",
        props: {
    ...
    if (customTitle === null && faviconURL === null) {
      ...
      this.#customConfig = [
        ...
        },
        {
          ...
          content:
            customTitle ??
            "OnesLLM | Your personal LLM trained on anything",
        },
      ];
    }
